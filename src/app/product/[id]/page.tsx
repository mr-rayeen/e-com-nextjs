		...
		<div className="bg-gray-50">
			...
			<div className="bg-gradient-to-r from-red-500/10 to-red-600/10 py-6 px-4">
				<div className="container mx-auto">
					<h1 className="text-2xl md:text-4xl font-bold text-center text-red-600 md-3">
						🔥 FLASH SALE - 80% OFF! 🔥
					</h1>
					<div className="flex flex-col items-center gap-2">
						<p className="text-center text-red-500 text-sm md:text-base font-semibold animate-pulse ">
							⚡ Only {Math.floor(Math.random() * 10 + 1)}{" "}
			...
			<div className="container mx-auto py-8">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					{/* Product Image */}
					{product.image && (
						<div className="bg-white aspect-square p-4 rounded-2xl overflow-hidden shadow-lg">
					...
					<div className="flex flex-col gap-4">
						...
						<div className="flex flex-col gap-2 mt-4">
							<div className="flex items-center gap-3">
								...
								<div className="flex flex-col gap-1">
									...
									<div className="flex items-center gap-2">
										<span className="bg-red-600 text-white px-2 py-0.5 rounded-full text-sm font-bold animate-pulse">
											−80%
										</span>
							...
							<div className="flex items-center gap-2 text-xs text-gray-600">
								<span className="inline-block size-2 bg-green-600 rounded-full animate-pulse"></span>
								<span>
									{Math.floor(
										Math.random() * 50 + 20
									)}{" "}
									people bought in last hour
								</span>
							</div>
						</div>
						...
						<div className="flex flex-col gap-3 mt-6 text-sm bg-white p-4 rounded-xl shadow-sm border border-gray-200 ">
